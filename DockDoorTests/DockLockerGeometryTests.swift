...
struct NudgeDirectionTests {
    @Test func nudgeDirectionBottom() {
        let frames = [
            CGRect(x: 0, y: 0, width: 1920, height: 1080),
            CGRect(x: 1920, y: 0, width: 1920, height: 1080),
        ]
    ...
    @Test func nudgeDirectionLeft() {
        // Screens with a gap so left edge is exposed
        let frames = [
            CGRect(x: 0, y: 0, width: 1920, height: 1080),
            CGRect(x: 2000, y: 0, width: 1920, height: 1080),
        ]
